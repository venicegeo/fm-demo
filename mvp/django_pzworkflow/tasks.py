...
@shared_task(name="django_pzworkflow.tasks.task_update_layers")
def task_update_layers():
    ...
    name = "django_pzworkflow.tasks.task_update_layers"
...
@shared_task(name="django_pzworkflow.tasks.task_update_tiles")
